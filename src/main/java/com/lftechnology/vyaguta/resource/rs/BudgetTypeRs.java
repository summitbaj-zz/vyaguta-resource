...
public class BudgetTypeRs {
  ...
  public Response list(
    ...
    List<BudgetType> budgetTypes = budgetTypeService.find(page.getStart(),
        page.getOffset());
    return Response.status(Response.Status.OK)
        .entity(JsonToStringBuilder.toString(budgetTypes)).build();
  }
  ...
  public Response create(@NotNull @Valid BudgetType budgetType) {
    ...
    return Response.status(Response.Status.OK)
        .entity(JsonToStringBuilder.toString(budgetType)).build();
  }
  ...
  public Response update(@PathParam("id") String id,
      @NotNull @Valid BudgetType budgetTypeNew) {
