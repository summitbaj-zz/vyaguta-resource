(function ($) {
    ...
    ColorSelector.prototype = {
        ...
        _init: function () {
            ...
            var $markupA = $("<a>").attr("data-toggle", "dropdown").addClass("dropdown-toggle").attr("href", "#aa").append($markupSpan);
            ...
            $("option", this.$select).each(function () {
                ...
                $markupA.attr("href", "javascript:void(0)").attr("data-color", color).attr("data-value", value).attr("title", title);
