        ...
        render: function () {
            return (
                <ul className="nav navbar-nav-custom pull-right">
                    <li className="dropdown"> <a className="dropdown-toggle" data-toggle="dropdown"> <i className="fa fa-bell fa-fw"></i> <i className="fa fa-caret-down"></i> </a>
                    ...
                    <li className="dropdown"> <a href="javascript:void(0)" className="dropdown-toggle" data-toggle="dropdown">
                        <img className="profile-img img-circle" src="dist/img/placeholders/avatar.png" alt="avatar"/> <i className="fa fa-angle-down"></i> </a>
