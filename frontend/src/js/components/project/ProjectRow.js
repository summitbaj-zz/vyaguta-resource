        ...
        render: function () {
            ...
            return (
                <tr>
                    ...
                    <td><Link to={urlConstants.PROJECTS.INDEX + '/' + id +  urlConstants.PROJECTS.VIEW}>{this.props.project.title}</Link></td>
                    ...
                    <td className="text-center">
                        <div className="btn-group"><Link to={urlConstants.PROJECTS.INDEX + '/' + id} data-toggle="tooltip"
                                                         title="Edit"
                                                         className="btn btn-sm btn-default"><i
                            className="fa fa-pencil"></i></Link>
                            <Link to={urlConstants.PROJECTS.INDEX +'/' + id +  urlConstants.PROJECTS.VIEW} data-toggle="tooltip"
                                  title="View Details"
                                  className="btn btn-sm btn-default"><i
